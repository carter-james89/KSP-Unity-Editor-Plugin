...
public class DebugVector : MonoBehaviour
{
    ...
    public static void DrawVector(Transform transformToDraw, Direction dir, float length, float width, Color colorX, Color colorY, Color colorZ)
    {
    ...
    public void CustomAwake(Direction dir, float length, float width, Color colorX, Color colorY, Color colorZ)
    {
    ...
    public void CreateVector(Direction dir, float length, float width, Color colorX, Color colorY, Color colorZ)
    {
        if(dir == Direction.x || dir == Direction.all)
        {
        ...
        if (dir == Direction.y || dir == Direction.all)
        {
        ...
        if (dir == Direction.z || dir == Direction.all)
        {
