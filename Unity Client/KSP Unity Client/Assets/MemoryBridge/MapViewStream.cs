...
namespace Winterdom.IO.FileMap
{
    ...
    public class MapViewStream : Stream, IDisposable
    {
                                 ...
                                 MapProtection protection)
        {
            ...
            _position = 0;
           //UnityEngine.Debug.Log("base address " + baseAddress);
           //UnityEngine.Debug.Log(baseAddress != IntPtr.Zero);
            _isOpen = (baseAddress != IntPtr.Zero);
          //  _isOpen = true;
           //UnityEngine.Debug.Log("_isOpen" + _isOpen);
        }
        ~MapViewStream()
        {
            Dispose(false);
        ...
        {
           //UnityEngine.Debug.Log("close mem map");
            Dispose(true);
        }
        ...
        public void Dispose()
        {
           ////UnityEngine.Debug.Log("dispose mem map");
            Dispose(true);
        }

        protected virtual void Dispose(bool disposing)
        {
          // //UnityEngine.Debug.Log("dispose mem map1");
            if (IsOpen)
            {
                Flush();
                // FIX: eliminate cast
                Win32MapApis.UnmapViewOfFile(_base);
               //UnityEngine.Debug.Log("Dispose isOpen = false");
                IsOpen = false;
            }
